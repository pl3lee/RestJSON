                            ...
                            <div className="flex flex-col justify-center space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[600px] text-muted-foreground md:text-xl">
                                        RestJSON lets you create, edit, and
                                        deploy JSON-based APIs in seconds. No
                                        installation required, just edit and go.
                                    </p>
                                </div>
                        ...
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    All the power of JSON Server with none of
                                    the setup. Create, edit, and deploy JSON
                                    APIs in seconds.
                                </p>
                            </div>
                        </div>
                        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
                            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                                ...
                                <p className="text-center text-muted-foreground">
                                    Edit your JSON files directly in the browser
                            ...
                            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                                ...
                                <p className="text-center text-muted-foreground">
                                    Your JSON structure automatically becomes
                            ...
                            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
                                ...
                                <p className="text-center text-muted-foreground">
                                    Control access to your API with API keys and
                                    authentication.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    Get your API up and running in minutes, not
                                    hours.
                                </p>
                            </div>
                        </div>
                        <div className="mx-auto grid max-w-5xl gap-8 py-12">
                            <div className="grid gap-8 md:grid-cols-[1fr_2fr]">
                                ...
                                <div className="flex flex-col justify-center space-y-4">
                                    ...
                                    <p className="text-muted-foreground">
                                        Create an account or sign in to get
                                        started with RestJSON.
                                    </p>
                                </div>
                            </div>
                            <div className="grid gap-8 md:grid-cols-[1fr_2fr]">
                                ...
                                <div className="flex flex-col justify-center space-y-4">
                                    ...
                                    <p className="text-muted-foreground">
                                        Create a new JSON file or upload an
                            ...
                            <div className="grid gap-8 md:grid-cols-[1fr_2fr]">
                                ...
                                <div className="flex flex-col justify-center space-y-4">
                                    ...
                                    <p className="text-muted-foreground">
                                        Use our intuitive editor to structure
                                        your data however you want.
                                    </p>
                                </div>
                            </div>
                            <div className="grid gap-8 md:grid-cols-[1fr_2fr]">
                                ...
                                <div className="flex flex-col justify-center space-y-4">
                                    ...
                                    <p className="text-muted-foreground">
                                        Generate an API key to secure access to
                                        your endpoints.
                                    </p>
                                </div>
                            </div>
                            <div className="grid gap-8 md:grid-cols-[1fr_2fr]">
                                ...
                                <div className="flex flex-col justify-center space-y-4">
                                    ...
                                    <p className="text-muted-foreground">
                                        Use your API endpoints from any
                    ...
                    <div className="container px-4 md:px-6 mx-auto">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    RestJSON is perfect for a variety of
                                    scenarios.
                                </p>
                            </div>
                        </div>
                        <div className="mx-auto grid max-w-5xl gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
                            <div className="flex flex-col space-y-3 rounded-lg border p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Quickly create mock APIs for your frontend
                                    applications without setting up a backend.
                                </p>
                            </div>
                            <div className="flex flex-col space-y-3 rounded-lg border p-6">
                                <h3 className="text-xl font-bold">
                                ...
                                <p className="text-muted-foreground">
                                    Test your mobile app against real API
                                    endpoints with customizable data.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col space-y-3 rounded-lg border p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Build functional prototypes in hours instead
                                    of days by using RestJSON as your backend.
                                </p>
                            </div>
                            <div className="flex flex-col space-y-3 rounded-lg border p-6">
                                <h3 className="text-xl font-bold">
                                ...
                                <p className="text-muted-foreground">
                                    Teach API concepts without the complexity of
                            ...
                            <div className="flex flex-col space-y-3 rounded-lg border p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Perfect for small projects that need a
                                    simple data store without the overhead of a
                                    full backend.
                                </p>
                            </div>
                            <div className="flex flex-col space-y-3 rounded-lg border p-6">
                                ...
                                <p className="text-muted-foreground">
                                    Create mock APIs that match your production
                                    API structure for testing and development.
                                </p>
                            </div>
                        </div>
                    </div>

...
export function ApiKeysManager() {
    ...
    const { data: apiKeysMetadata, isLoading: apiKeysMetadataLoading } =
        useQuery({
            ...
            <Card>
                            ...
                            >
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Please copy your API key now. You
                                    ...
                                    >
                                        ...
                                        <AlertDescription>
                                            This API key will only be displayed
                ...
                <CardFooter className="border-t px-6 py-4">
                    <p className="text-sm text-muted-foreground">
                        API keys provide full access to JSON files in your
                        account. Keep them secure and never share them in public

			...
			>
				...
				<div className="space-y-4 py-4" id="dialog-description">
					...
					<div className="space-y-2">
						<h4 className="text-base font-medium">Example usage:</h4>
						<CodeBlock
						...
						<div className="space-y-3">
							...
							<div className="relative">
								...
								<Button
									variant="ghost"
									size="icon"
									className="absolute right-2 top-2 h-8 w-8 rounded-full bg-white/80 dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-700"
